...
import type {ImageLink} from "./types/ImageLink.ts";
...
export const SKILLS: Record<string, ImageLink> = {
    ...
    [Skill.RABBIT_MQ]: {
        ...
        image: "/assets/skill/rabbit_mq.png"
    },
    [Skill.KAFKA]: {
        title: Skill.KAFKA,
    ...
    [Skill.DOCKER_COMPOSE]: {
        title: Skill.DOCKER_COMPOSE,
        url: "https://docs.docker.com/compose/gettingstarted/",
        image: "/assets/skill/docker_compose.png"
    },
